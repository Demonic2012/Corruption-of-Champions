...
package classes.Items
{
	...
	public final class ArmorLib
	{
		...
		public const SWHBIKNI:ArmorWithPerk = new ArmorWithPerk("SWhBikini","S Wh Bikini","Sexy White Bikini","a Sexy White Bikini",0,0,160,"This item helps female swimmers look sexy while not hindering movement. A perfect dress for a day at the beach.","Light",
				PerkLib.SluttySeduction,10,0,0,0,"Your revealing chain bikini allows you access to 'Seduce', an improved form of 'Tease'.", false, false);
		public const SW_ROBE:ArmorWithPerk = new ArmorWithPerk("SW.Robe","SW.Robes","spider-weave robes","a spider-woven robes",7,18,3000,A set of finely woven mage robes made from the silk of a Drider. Due to the braided structure of the white robes, it feels like you're wearing a bunch of comfortable, tiny silk ropes. While not as protective as proper armor, these enchanted robes are light, sturdy and at times, seem to sparkle a little. The front has a barely noticable web-motif pattern to it, and the sleeves are roomy, but tightens up a little at the wrists, allowing for unhindered movement.","Light",PerkLib.WizardsEndurance,50,0,0,0);		
